            ...
            {EXPERIENCE.map((exp, index) => (
              <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700 h-full flex flex-col">
                <div className="mb-4">
                  ...
                  <h4 className="text-lg text-yellow-400 mb-2 font-semibold">{exp.company}</h4>
                ...
                <ul className="text-left space-y-3 flex-grow">
                  {exp.bullets.map((bullet, bulletIndex) => (
                    <li key={bulletIndex} className="text-sm leading-relaxed" style={{ color: '#f5f5dc' }}>
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
              ...
              <p className="text-sm mt-2" style={{ color: '#f5f5dc' }}>Native</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
              <h3 className="text-2xl font-bold text-white mb-4">Spanish</h3>
              <div className="flex justify-center space-x-1">
                {[...Array(5)].map((_, i) => (
                  <span key={i} className="text-yellow-400 text-2xl">★</span>
                ))}
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
              <h3 className="text-2xl font-bold text-white mb-4">Portuguese</h3>
              <div className="flex justify-center space-x-1">
                {[...Array(3)].map((_, i) => (
                  <span key={i} className="text-yellow-400 text-2xl">★</span>
                ))}
              </div>
              <p className="text-sm mt-2" style={{ color: '#f5f5dc' }}>Elementary</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700 max-w-md mx-auto">
            <div className="mb-6">
              ...
              <p className="text-sm mb-6" style={{ color: '#f5f5dc' }}>
            ...
            <a 
              ...
              className="inline-flex items-center px-6 py-3 bg-yellow-300 text-gray-900 font-semibold rounded-lg hover:bg-yellow-200 transition-colors duration-300"
            >
      ...
      <section id="contact" className="py-24 flex items-center justify-center p-6" style={{ fontFamily: 'var(--font-space-mono), ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace' }}>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <a 
              href={`mailto:${email}`}
              className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700 hover:border-white/30 transition-all duration-300 block hover:scale-105 cursor-pointer"
            >
